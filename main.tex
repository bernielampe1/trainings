...
\begin{enumerate}
	...
	\item It is better to start from the input vector and read through the code which handles the input data.
\end{enumerate}

% Identify unsanitized parameters, validate all ranges and math done on the input data
...
void copy_buffer(unsigned char *in_buf, unsigned inbuf_size)
{
